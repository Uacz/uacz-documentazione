...
Quando la montatura viene stazionato sul meridiano locale, qui inserisci l'orario del meridiano locale (ad esempio 23h) in corrispondenza del riferimento, ed è il punto che userai per azzerare o leggere la scala durante lo stazionamento e nell'uso normale della montatura.[](https://simonelochivisualarts.com/2024/03/28/montature-go-to-coordinate-celesti-puntamento-automatico-ed-autoguida-vediamo-di-capire-come-funzionano/)​
